...
/*
	...
	Args: [{ false mesh ArrayMesh} {False true billboard bool} {[RID] true skeleton RID} {Null true material Material}], Returns: void
*/
func (o *EditorSpatialGizmo) AddMesh(mesh ArrayMeshImplementer, billboard gdnative.Bool, skeleton gdnative.Rid, material MaterialImplementer) {
...
type EditorSpatialGizmoImplementer interface {
	...
	AddMesh(mesh ArrayMeshImplementer, billboard gdnative.Bool, skeleton gdnative.Rid, material MaterialImplementer)
